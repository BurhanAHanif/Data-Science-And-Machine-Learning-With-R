...
x = sum(0:499)
prod(1/2^x)
# the number with all the powers added which is x then 2 to that power. I think that is what you mean by saying express it another way
```
...
```{r}
sum(sample(0:1, 500 , replace = TRUE, c(0.1,0.9))/100)
